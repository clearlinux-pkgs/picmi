...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/picmi-22.08.0.tar.xz
...
%prep
%setup -q -n picmi-22.08.0
cd %{_builddir}/picmi-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661530169
mkdir -p clr-build
pushd clr-build
