...
Version  : 22.12.1
Release  : 48
URL      : https://download.kde.org/stable/release-service/22.12.1/src/picmi-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/picmi-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/picmi-22.12.1.tar.xz.sig
...
%prep
%setup -q -n picmi-22.12.1
cd %{_builddir}/picmi-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673278984
mkdir -p clr-build
pushd clr-build
