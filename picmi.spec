...
Version  : 23.08.4
Release  : 62
URL      : https://download.kde.org/stable/release-service/23.08.4/src/picmi-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/picmi-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/picmi-23.08.4.tar.xz.sig
...
%prep
%setup -q -n picmi-23.08.4
cd %{_builddir}/picmi-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702924492
mkdir -p clr-build
pushd clr-build
