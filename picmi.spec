...
Version  : 24.05.1
Release  : 69
URL      : https://download.kde.org/stable/release-service/24.05.1/src/picmi-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/picmi-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/picmi-24.05.1.tar.xz.sig
...
%setup -q -n picmi-24.05.1
cd %{_builddir}/picmi-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718378901
mkdir -p clr-build
pushd clr-build
