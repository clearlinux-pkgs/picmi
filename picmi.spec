...
Version  : 24.02.2
Release  : 66
URL      : https://download.kde.org/stable/release-service/24.02.2/src/picmi-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/picmi-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/picmi-24.02.2.tar.xz.sig
...
%prep
%setup -q -n picmi-24.02.2
cd %{_builddir}/picmi-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712857100
mkdir -p clr-build
pushd clr-build
